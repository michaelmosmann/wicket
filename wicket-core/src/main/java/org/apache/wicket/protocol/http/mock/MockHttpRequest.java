...
public class MockHttpRequest implements IHttpRequest
{
	...
	/** Logging object */
	private static final Logger log = LoggerFactory.getLogger(MockHttpRequest.class);
	 ...
	 */
	public MockHttpRequest(final Application application, final IHttpSession session,
		final IHttpContext context)
	{
...
// }
	 ...
	 */
	@Override
	public IHttpSession getSession(boolean b)
	{
		IHttpSession sess = null;
