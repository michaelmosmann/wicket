 ...
 */
@_HaveToRefactor
public class MockHttpContext implements IHttpContext
{
	private static final Logger log = LoggerFactory.getLogger(MockHttpContext.class);
	 ...
	 */
	public MockHttpContext(final Application application, final String path)
	{
		...
		// the user app can configure specific work folder by setting -Dwicket.tester.work.folder
// JVM option,
...
// */
// @Override
// public IHttpContext getContext(String name)
// {
// return this;
// }
